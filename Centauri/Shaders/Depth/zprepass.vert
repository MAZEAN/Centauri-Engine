...
// Per-material UV tiling — a uniform (set per submesh, see GeometryPrepass/ZPrepass's own
// SetMeshState), not a per-instance attribute. Must match the lit pass's uUvScale/uUvOffset.
